...
sendJsonResponse(true, "App version configuration retrieved.", [
    ...
    "update_message"       => "v1.4.8 is live! Completely redesigned PDF presentation brochures with modern cover slides, activation maps, and DMIC master plan infographics.",
    "force_update"         => false
]);

...
try {
    ...
    // Auto-seed sample properties if table is currently empty
    $propCheckStmt = $db->query("SELECT COUNT(*) as total FROM properties");
    $propCount = (int)$propCheckStmt->fetch()['total'];
    ...
    if ($propCount === 0) {
        ...
        echo "<div style='margin-top: 10px; color: var(--success); font-weight: bold;'>🌱 Automatically seeded initial sample property listings into database!</div>";
    }
